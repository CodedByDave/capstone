...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\thesis\public\storage' => 'string',
            ...
            'services.paymongo.secret_key' => 'string',
            'services.paymongo.public_key' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\thesis\\public\\storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.paymongo.secret_key','services.paymongo.public_key',
...
'register.store','verification.verify','verification.send','password.confirmation','password.confirm.store',
'two-factor.login.store','two-factor.enable','two-factor.confirm','two-factor.disable','two-factor.qr-code',
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','admin.dashboard','admin.settings','shop.index',
'shop.show','shop.edit','shop.update','shop.destroy','shop.disable',
'shop.enable','admin.users.index','admin.users.bulk-archive','admin.users.archive.index','admin.users.archive.restore',
'admin.users.archive.bulk-restore','admin.users.archive.force-delete','admin.users.show','admin.users.destroy','admin.login-logs.index',
'admin.login-logs.destroy','admin.login-logs.bulk-archive','admin.login-logs.archive.index','admin.login-logs.archive.restore','admin.login-logs.archive.bulk-restore',
'admin.login-logs.archive.force-delete','admin.orders.index','admin.orders.show','admin.analytics','shop.dashboard',
'shop.data','checkout','payment.success','payment.cancel','logs.index',
'employee.create','employee.archive','employee.import.template','employee.import','employee.bulk-restore',
'employee.index','employee.store','employee.show','employee.edit','employee.update',
'employee.destroy','employee.restore','schedule.store','schedule.update','schedule.destroy',
'branch.create','branch.archive','branch.restore','branch.index','branch.store',
'branch.edit','branch.update','branch.destroy','shop.permission','shop.permission.update',
'shop.permission.roles.store','shop.permission.roles.destroy','shop.permission.employee.toggle','inventory.category.index','inventory.category.store',
'inventory.category.edit','inventory.category.update','inventory.category.destroy','inventory.category.archive','inventory.category.restore',
'inventory.alerts.index','inventory.alerts.mark-all-read','inventory.alerts.update','inventory.index','inventory.create',
'inventory.store','inventory.show','inventory.edit','inventory.update','inventory.destroy',
'inventory.adjust','supplier.index','supplier.create','supplier.store','supplier.edit',
'supplier.update','supplier.destroy','supplier.archive','supplier.restore','reports.overview',
'reports.inventory','reports.employee','staff.dashboard','staff.employee.index','staff.employee.create',
'staff.employee.store','staff.employee.archive','staff.employee.bulk-restore','staff.employee.import.template','staff.employee.import',
'staff.employee.show','staff.employee.edit','staff.employee.update','staff.employee.destroy','staff.employee.restore',
'staff.schedule.store','staff.schedule.update','staff.schedule.destroy','staff.branch.index','staff.branch.create',
'staff.branch.store','staff.branch.archive','staff.branch.restore','staff.branch.edit','staff.branch.update',
'staff.branch.destroy','staff.inventory.category.index','staff.inventory.category.archive','staff.inventory.category.store','staff.inventory.category.restore',
'staff.inventory.category.destroy','staff.inventory.category.edit','staff.inventory.category.update','staff.inventory.index','staff.inventory.create',
'staff.inventory.store','staff.inventory.edit','staff.inventory.update','staff.inventory.adjust','staff.inventory.destroy',
'staff.inventory.alerts.index','staff.inventory.alerts.mark-all-read','staff.inventory.alerts.update','staff.inventory.show','staff.supplier.index',
'staff.supplier.create','staff.supplier.store','staff.supplier.edit','staff.supplier.update','staff.supplier.archive',
'staff.supplier.restore','staff.supplier.destroy','staff.logs.index','staff.reports.overview','staff.reports.inventory',
'staff.reports.employee','dashboard','profile.edit','profile.update',
'profile.destroy','user-password.edit','user-password.update','appearance.edit','two-factor.show',
'login.user','register.shop','register.shop.store','password.request','password.reset',
'otp.verify.page','otp.verify','otp.resend','storage.local',);
        registerArgumentsSet('views', 
'app','emails.otp','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.xampp.htdocs.thesis.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'QUEUE_CONNECTION','CACHE_STORE','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
...
'VITE_APP_NAME','PAYMONGO_SECRET_KEY','PAYMONGO_PUBLIC_KEY','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',
'GOOGLE_REDIRECT_URI',);
