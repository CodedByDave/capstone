...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Archive', href: '/shop/supplier/archive' },
]
...
function restoreSupplier(id: number) {
    ...
    router.post(`/shop/supplier/${id}/restore`, {}, {
        preserveScroll: true,
        onSuccess: () => toast.success('Supplier restored successfully.', { autoClose: 3000 }),
        onError:   () => toast.error('Failed to restore supplier.', { autoClose: 4000 }),
                    ...
                    <div class="rounded-lg border overflow-hidden">
                        <table class="w-full text-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-if="archived.data.length === 0">
