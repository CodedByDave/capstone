...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add Item', href: '/shop/inventory/create' },
]
    ...
    <ShopLayout :breadcrumbs="breadcrumbs" title="Add Inventory Item">
        <div class="px-6 space-y-8">
                ...
                <div class="grid grid-cols-12 gap-x-6 gap-y-5">
                    ...
                    <div class="col-span-12 sm:col-span-3 space-y-1">
                        ...
                        <Select v-model="form.unit">
                            <SelectTrigger :class="{ 'border-red-500': form.errors.unit }">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t">
                <Button variant="outline" :disabled="form.processing" @click="router.visit('/shop/inventory')">
                    Cancel
                </Button>
