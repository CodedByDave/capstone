...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/shop/inventory/${inventory.id}/edit` },
]
...
function submit() {
    form.put(`/shop/inventory/${inventory.id}`)
}
</script>
    ...
    <ShopLayout :breadcrumbs="breadcrumbs" title="Edit Inventory Item">
        <div class="px-6 space-y-8">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t">
                <Button variant="outline" :disabled="form.processing" @click="router.visit(`/shop/inventory/${inventory.id}`)">
                    Cancel
                </Button>
