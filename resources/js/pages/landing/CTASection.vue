...
<template>
    <section ref="sectionRef" class="py-24 lg:py-32 bg-primary">
        <div :class="[
            ...
            <h2 class="font-serif text-3xl sm:text-4xl font-bold tracking-tight text-primary-foreground sm:text-5xl lg:text-6xl text-balance">
            ...
            <div class="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                <Button @click="router.visit('/register/shop')" size="lg" class="w-full sm:w-auto bg-card text-foreground hover:bg-secondary px-8 py-6 text-base shadow-none group">
                    Register Your Shop
                    <ArrowRight class="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                </Button>
                <Button variant="outline" size="lg"
                    class="w-full sm:w-auto border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 px-8 py-6 text-base bg-transparent">
                    Contact Sales
                </Button>
            </div>
        </div>
